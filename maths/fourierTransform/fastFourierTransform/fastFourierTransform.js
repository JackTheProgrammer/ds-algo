import ComplexNumber from "../../complexNumber/complexNumber";
import bitsLength from "../../bit manipulation/bitsLength/bitsLength";
...
export default function fastFourierTransform(inputData, inverse = false) {
    const bitsCount = bitsLength(inputData.length - 1);
    const N = 1 << bitsCount;
